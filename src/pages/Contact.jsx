...
const Contact = () => {
  ...
  const workbookRef = useRef(null); // store workbook between submissions
...
const handleBookConsultation = (e) => {
  ...
  if (!fileCreated) {
    ...
    // File already exists → append new data
                  ...
                  <form onSubmit={handleBookConsultation}>
                    <div className="row g-3">
                      ...
                      <div className="col-12 text-center">
                        <button className="btn btn-warning px-4 mt-3 fw-bold" type="submit">Book Consultation Now</button>
                      </div>
                    </div>
                  </form>
