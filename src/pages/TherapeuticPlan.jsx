...
const TherapeuticPlan = () => {
    ...
    const handleMealTypeChange = (value) => setMealType(value);
    const handlePlanChange = (value) => setPlan(value);
    const handlePreferenceChange = (value) => setPreference(value);
                ...
                <div className="container d-flex flex-wrap justify-content-between gap-4">
                    ...
                    <div className="content-box position-relative text-overlay">
                        ...
                        <h1 className="overlay-heading">
                            Therapeutic <h1 className='overlay-heading-plan'>Plan</h1>
                        </h1>
                        <div className="content-info">
                            <h2>Therapeutic Plans – Tailor-Made for You</h2>
                    ...
                    <div className="interactive-form">
                        <h2>
                            <span className="title-main">THERAPEUTIC </span>
