            ...
            <section className="therapeutic-section">
                <div className="container d-flex flex-wrap justify-content-between gap-4">
                    <div className="content-box position-relative text-overlay">
                        <img
                            src="./images/dietin4.png"
                            alt="Therapeutic Dish"
                            className="content-img"
                        />
                        <h1 className="overlay-heading">Pregnancy & Lactation  <h1 className='overlay-heading-plan'>Plan</h1></h1>

                        <div className="content-info">
                            <h2>Pregnancy & Lactation Plans – Tailor-Made for You</h2>
                    ...
                    <div className="interactive-form">
                        <h2>
                            <span className="title-main">Pregnancy & Lactation  </span>
...
export default TherapeuticPlan1;
