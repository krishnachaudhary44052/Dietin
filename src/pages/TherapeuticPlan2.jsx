            ...
            <section className="therapeutic-section">
                <div className="container d-flex flex-wrap justify-content-between gap-4">
                    <div className="content-box position-relative text-overlay">
                        ...
                        />
                        <h1 className="overlay-heading">Gym and
                            Sports <h1 className='overlay-heading-plan'>Plan</h1></h1>

                        <div className="content-info">
                            <h2>Gym and
                                Sports Plans – Tailor-Made for You</h2>
                    ...
                    <div className="interactive-form">
                        <h2>
                            <span className="title-main">Gym and
                                Sports </span>
...
export default TherapeuticPlan2;
